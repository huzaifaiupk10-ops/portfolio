...
export default function Footer() {
  ...
  return (
    <footer
      ...
      style={{
        background: '#000000',
        borderTop: '1px solid rgba(200,149,106,0.08)',
      }}
    >
      {/* Top glow */}
      <div
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <span
                ...
                style={{ background: 'linear-gradient(135deg,#9A6840,#C8956A)' }}
              >
                HI
              </span>
              <span className="font-display font-semibold text-brand-silver-light">
                Huzaifa<span style={{ color: '#C8956A' }}>.</span>
              </span>
            </div>
        ...
        <div
          ...
          style={{ background: 'linear-gradient(90deg, transparent, rgba(200,149,106,0.12), transparent)' }}
        />
