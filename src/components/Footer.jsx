...
export default function Footer() {
  ...
  return (
    <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '2rem var(--gutter)' }}>
      <div style={{ maxWidth: 'var(--max-w)', margin: '0 auto', display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: isMobile ? 'center' : 'space-between', alignItems: 'center', gap: '1rem', textAlign: isMobile ? 'center' : 'left' }}>
