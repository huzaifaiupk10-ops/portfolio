  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label className="text-sm font-medium" style={{ color: '#CBD5E1' }}>
        {label} {required && <span style={{ color: '#C8A898' }}>*</span>}
      </label>
      <input
        type={type}
        name={name}
        ...
        onFocus={(e) => {
          ...
          e.currentTarget.style.boxShadow = '0 0 0 3px rgba(200,168,152,0.08)';
        }}
        onBlur={(e) => {
            ...
            {[
              ...
              >
                <div
                  ...
                  style={{ background: 'rgba(200,168,152,0.12)', color: '#C8A898', border: '1px solid rgba(200,168,152,0.2)' }}
                >
                  {item.icon}
                </div>
                <div>
            ...
            <AnimatePresence mode="wait">
              {status === 'success' ? (
                <motion.div
                  ...
                  style={{
                    background: 'rgba(5,13,26,0.65)',
                    border: '1px solid rgba(200,168,152,0.25)',
                  }}
                >
                  <div
                    className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5"
                    style={{ background: 'rgba(200,168,152,0.15)', border: '1px solid rgba(59,130,246,0.3)' }}
                  >
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#C8A898" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                ...
                >
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-sm font-medium" style={{ color: '#CBD5E1' }}>
                      Message <span style={{ color: '#C8A898' }}>*</span>
                    </label>
                    <textarea
                      name="message"
                      value={form.message}
