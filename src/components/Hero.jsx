  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: 'linear-gradient(to bottom, #C8956A, transparent)' }}
      />
    </motion.div>
  );
}
      ...
      <div className="relative z-10 container-max w-full px-4 md:px-8 pt-24 pb-20">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-10 lg:gap-0">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            >
              <span className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: '#C8956A' }} />
              Available for Work
            </motion.div>
            ...
            >
              ...
              That Feel{' '}
              <span style={{
                background: 'linear-gradient(135deg,#C8956A,#F8F4EE)',
        ...
        <motion.div
          ...
          style={{ borderTop: '1px solid rgba(200,149,106,0.1)' }}
        >
          {[
