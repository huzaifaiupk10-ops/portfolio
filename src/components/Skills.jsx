  ...
  return (
    <motion.span
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 0 14px rgba(201,168,128,0.15)';
        ...
        >
          {skills.map((cat, i) => (
            <button
              ...
              style={{
                background:
                  activeTab === i ? 'rgba(201,168,128,0.15)' : 'rgba(5,13,26,0.65)',
                border:
                  activeTab === i
                    ? '1px solid rgba(59,130,246,0.4)'
                    : '1px solid rgba(201,168,128,0.1)',
                color: activeTab === i ? '#C9A880' : '#64748B',
              }}
            >
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            <span
              ...
              style={{ background: 'rgba(201,168,128,0.12)', border: '1px solid rgba(201,168,128,0.2)' }}
            >
              {current.icon}
            </span>
            <div>
