              ...
              >
                ...
                <motion.div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = '0 16px 40px rgba(0,0,0,0.3), 0 0 30px rgba(200,149,106,0.1)';
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: 'linear-gradient(135deg, rgba(30,64,175,0.4), rgba(200,149,106,0.2))',
                      border: '1px solid rgba(59,130,246,0.35)',
                      color: '#C8956A',
                      boxShadow: '0 0 20px rgba(200,149,106,0.15)',
                    }}
                  >
                    {step.step}
                  </div>
